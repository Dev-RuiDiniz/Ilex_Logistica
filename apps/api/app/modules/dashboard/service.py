    ...
    for sla_result in sla_results:
        ...
        if exc_type:
            ...
            top_exceptions.append({
                ...
                "invoice_value": float(shipment.invoice_value) if shipment.invoice_value is not None else None,
                "freight_value": float(shipment.freight_value) if shipment.freight_value is not None else None,
