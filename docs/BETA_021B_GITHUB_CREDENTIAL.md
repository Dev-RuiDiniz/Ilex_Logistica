# BETA-021B — GitHub Credential Handling
...
**Bloqueio Técnico Formal:** Não há credencial GitHub válida no ambiente (mesmo bloqueio de BETA-021A).
...
- Documentar bloqueio em BETA_021B
