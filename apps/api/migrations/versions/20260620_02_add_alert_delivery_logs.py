...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('delivery_channel', sa.String(length=50), nullable=False, server_default='in_app'),
        sa.Column('delivery_status', sa.String(length=20), nullable=False, server_default='success'),
